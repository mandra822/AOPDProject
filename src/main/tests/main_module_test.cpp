...
TEST_CASE( "GPU test", "[gpu][concurrent][!mayfail]" ) {
    srand(time(NULL));
...
TEST_CASE( "Concurrent cpu test", "[cpu][concurrent][!mayfail]" ) {
    srand(time(NULL));
    FileManager fileManager {};
    auto testFiles = fileManager.loadTestInitFile("instances/test_file_setup.txt");
    for (auto file : testFiles) {
...
TEST_CASE( "Non-concurrent cpu test", "[cpu][nonconcurrent][!mayfail]" ) {
    srand(time(NULL));
    FileManager fileManager {};
    auto testFiles = fileManager.loadTestInitFile("instances/test_file_setup.txt");
    for (auto file : testFiles) {
